...
const products: ProductType[] = [
    {
        id: 1,
        section: "Compañía",
        link: ['Sobre nosotros', 'Blog', 'Contáctanos', 'Precios', 'Testimonios'],
    },
    {
        id: 2,
        section: "Soporte",
        link: ['Centro de ayuda', 'Términos del servicio', 'Legal', 'Política de privacidad', 'Estado']
    }
]
    ...
    return (
        <div className="bg-bgpurple -mt-64" id="first-section">
            <div className="mx-auto max-w-2xl pt-64 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4'>
                        <img src={'/assets/logo/CeroMPrintLogo.svg'} alt="logo CeroMPrint" className='pb-4' />
                        <h3 className='text-white text-lg font-medium leading-9 mb-4 lg:mb-20'> Lleva tus diseños al mundo real con <br /> la impresión 3D de CeroMPrint. </h3>
                    ...
                    <div className='col-span-4'>
                        ...
                        <div className="relative text-white focus-within:text-white flex flex-row-reverse">
                            <input type="Email address" name="q" className="py-4 text-sm w-full text-white bg-gray-900 rounded-md pl-4 focus:outline-none bg-emailbg focus:text-white" placeholder="Tu dirección de correo" autoComplete="off" />
            ...
            <div className='pb-24 px-4'>
                <h3 className='text-center text-offwhite'>©2023 - Todos los derechos reservados por <Link href="https://ceromprint.com/" target="_blank"> CeroMPrint.com</Link></h3>
            </div>
